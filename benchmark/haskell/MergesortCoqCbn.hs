    ...
    let {
     merge' ys0 =
       case ys0 of {
        ...
        (:) y ys' ->
         case leT x y of {
          Prelude.True -> (:) x (merge0 leT xs' ys0);
...
merge_R leT_UU2081_ leT_UU2082_ leT_R xs_UU2081_ xs_UU2082_ xs_R ys_UU2081_ ys_UU2082_ ys_R =
                      ...
                      let {
                       merge' ys0 =
                         case ys0 of {
                          ...
                          (:) y ys' ->
                           case leT x y of {
                            Prelude.True -> (:) x (merge1 leT xs' ys0);
                            Prelude.False -> (:) y (merge' ys')}}}
                      in merge' ys}}
                 in merge1}
  in
  ...
  in
  let {
   merge_R1 leT_UU2081_0 leT_UU2082_0 leT_R0 xs_UU2081_0 xs_UU2082_0 xs_R0 ys_UU2081_0 ys_UU2082_0 ys_R0 =
     eq_rect
       (case xs_UU2081_0 of {
         ([]) -> ys_UU2081_0;
         (:) x xs' ->
             ...
             case ys of {
              ...
              (:) y ys' ->
               case leT_UU2081_0 x y of {
                Prelude.True -> (:) x (fix_merge_1 leT_UU2081_0 xs' ys);
                Prelude.False -> (:) y (merge' ys')}}}
          in merge' ys_UU2081_0})
       (eq_rect
         (case xs_UU2082_0 of {
           ([]) -> ys_UU2082_0;
           (:) x xs' ->
               ...
               case ys of {
                ...
                (:) y ys' ->
                 case leT_UU2082_0 x y of {
                  Prelude.True -> (:) x (fix_merge_2 leT_UU2082_0 xs' ys);
                  Prelude.False -> (:) y (merge' ys')}}}
            in merge' ys_UU2082_0})
         (case xs_R0 of {
           List_R_nil_R -> ys_R0;
                               ...
                               case ys of {
                                ...
                                (:) y ys' ->
                                 case leT_UU2081_0 x_UU2081_ y of {
                                  Prelude.True -> (:) x_UU2081_
                                   (fix_merge_1 leT_UU2081_0 xs'_UU2081_ ys);
                                  Prelude.False -> (:) y (merge' ys')}}}
                            in merge'}
            in
            let {
                               ...
                               case ys of {
                                ...
                                (:) y ys' ->
                                 case leT_UU2082_0 x_UU2082_ y of {
                                  Prelude.True -> (:) x_UU2082_
                                   (fix_merge_2 leT_UU2082_0 xs'_UU2082_ ys);
                                  Prelude.False -> (:) y (merge' ys')}}}
                            in merge'}
            in
            let {
             merge'_R ys_UU2081_1 ys_UU2082_1 ys_R1 =
               eq_rect
                 (case ys_UU2081_1 of {
                   ([]) -> xs_UU2081_0;
                   (:) y ys' ->
                    case leT_UU2081_0 x_UU2081_ y of {
                     Prelude.True -> (:) x_UU2081_
                      (fix_merge_1 leT_UU2081_0 xs'_UU2081_ ys_UU2081_1);
                     Prelude.False -> (:) y (fix_merge'_1 ys')}})
                 (eq_rect
                   (case ys_UU2082_1 of {
                     ([]) -> xs_UU2082_0;
                     (:) y ys' ->
                      case leT_UU2082_0 x_UU2082_ y of {
                       Prelude.True -> (:) x_UU2082_
                        (fix_merge_2 leT_UU2082_0 xs'_UU2082_ ys_UU2082_1);
                       Prelude.False -> (:) y (fix_merge'_2 ys')}})
                   (case ys_R1 of {
                     List_R_nil_R -> xs_R0;
                     List_R_cons_R y_UU2081_ y_UU2082_ y_R ys'_UU2081_
                      ...
                      case leT_R0 x_UU2081_ x_UU2082_ x_R y_UU2081_ y_UU2082_
                       ...
                       Bool_R_true_R -> List_R_cons_R x_UU2081_ x_UU2082_ x_R
                        (fix_merge_1 leT_UU2081_0 xs'_UU2081_ ys_UU2081_1)
                        (fix_merge_2 leT_UU2082_0 xs'_UU2082_ ys_UU2082_1)
                        (merge_R1 leT_UU2081_0 leT_UU2082_0 leT_R0
                          xs'_UU2081_ xs'_UU2082_ xs'_R ys_UU2081_1
                          ys_UU2082_1 ys_R1);
                       Bool_R_false_R -> List_R_cons_R y_UU2081_ y_UU2082_
                        y_R (fix_merge'_1 ys'_UU2081_)
                        (fix_merge'_2 ys'_UU2082_)
                        (merge'_R ys'_UU2081_ ys'_UU2082_ ys'_R)}})
                   (fix_merge'_2 ys_UU2082_1)) (fix_merge'_1 ys_UU2081_1)}
            in merge'_R ys_UU2081_0 ys_UU2082_0 ys_R0})
         (fix_merge_2 leT_UU2082_0 xs_UU2082_0 ys_UU2082_0))
       (fix_merge_1 leT_UU2081_0 xs_UU2081_0 ys_UU2081_0)}
  in merge_R1 leT_UU2081_ leT_UU2082_ leT_R xs_UU2081_ xs_UU2082_ xs_R
